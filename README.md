...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/jessicaa-huang/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/jessicaa-huang/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/jessicaa-huang/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/jessicaa-huang/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/jessicaa-huang/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/jessicaa-huang/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |    9m28.106s              |         1m06.35s          | 
| `pg_normalized_batch`  |    1m21.885s              |         14.481s           | 
| `pg_denormalized`      |    16.778s                |         3.409s            | 
